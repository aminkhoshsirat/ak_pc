...
class MainCategorySerializers(serializers.ModelSerializer):
    base_category_child = serializers.StringRelatedField(many=True, read_only=True)
...
class ChildCategorySerializers(serializers.ModelSerializer):
    child_category_image = serializers.StringRelatedField(read_only=True)
...
class ChildCategoryImageSerializers(serializers.ModelSerializer):
    child_category = serializers.StringRelatedField(read_only=True)
